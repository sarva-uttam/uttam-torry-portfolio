...
| 11 | **Unexpected third-party / AI cost** | No | No billable third-party call anywhere. Google Fonts is free and unmetered. No AI. **N/A.** |
| 12 | **Privacy / PII exposure** | **High** | The footer of all three pages and the downloadable CV publish a **full residential street address** with a Google Maps deep-link. Email + public social profiles are owner-approved. See finding V-1 and residual R1. |
